...
final readonly class DeletedAt implements DeletedAtInterface
{
    ...
    public static function nullable(): DeletedAtInterface
    {
     ...
     * @throws Exception
     */
    public static function random(): DeletedAtInterface
    {
        $random = (new DateTime())
    ...
    public static function now(): DeletedAtInterface
    {
     ...
     * @throws Exception
     */
    public static function create(string|null|DateTimeInterface $value): DeletedAtInterface
    {
        if ($value === null) {
            return new self(null);
        }
