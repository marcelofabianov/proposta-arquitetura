...
final readonly class CreatedAt implements CreatedAtInterface
{
     ...
     * @throws Exception
     */
    public static function random(): CreatedAtInterface
    {
        $random = (new DateTime())
    ...
    public static function now(): CreatedAtInterface
    {
     ...
     * @throws Exception
     */
    public static function create(string|DateTimeInterface $value): CreatedAtInterface
    {
